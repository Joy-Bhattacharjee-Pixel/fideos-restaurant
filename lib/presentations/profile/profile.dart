              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      width: 140,
                      child:
                          ButtonManager(onPressed: () {}, text: "Edit Profile")
                              .elevated()),
                  ...
                  _detail(icon: const Icon(Icons.person), title: "Anamika Jha"),

                  // Restaurant detail = email
                  _detail(
                      icon: const Icon(Icons.mail), title: "anmaika@gmail.com"),

                  // Restaurant detail = phone
                  _detail(icon: const Icon(Icons.phone), title: "786678988"),

                  // Restaurant detail 
                  _detail(icon: const Icon(Icons.logout), title: "Log Out"),
